...
def main():
    ...
    parser.add_argument("--min-inliers", type=int, default=8, help="Min RANSAC inliers")
    parser.add_argument("--lowe-ratio", type=float, default=0.90, help="Lowe's ratio test")
